...
public final class Constants {
  ...
  public static final class SDSConstants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = Math.toRadians(260);

    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 3;
    public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 4;
    public static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 14;
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = Math.toRadians(40);
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = Math.toRadians(10);
  }
  /**
